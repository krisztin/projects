...
const transportation = data.reduce((obj, item) => {
  // whilst it's looping through if it finds an item that's new then it assigns 0 to it...
  if (!obj[item]) {
    obj[item] = 0;
  }
  obj[item] += 1;
...
// ...because we don't know the items in the array or new ones could be added
// and it would be a pain to add all as a key between {} i.e. walk=0
